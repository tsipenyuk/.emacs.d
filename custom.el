...
(custom-set-faces
 ...
 '(font-latex-sectioning-0-face ((t (:foreground "#268bd2"))))
 '(font-latex-sectioning-1-face ((t (:foreground "#268bd2"))))
 '(font-latex-sectioning-2-face ((t (:foreground "#268bd2"))))
 '(font-latex-sectioning-3-face ((t (:foreground "#268bd2"))))
 '(font-latex-sectioning-4-face ((t (:foreground "#268bd2"))))
 '(font-latex-sectioning-5-face ((t (:inherit variable-pitch :foreground "#268bd2" :weight normal))))
 '(font-latex-sedate-face ((t (:foreground "#859900"))))
 '(font-latex-slide-title-face ((t (:inherit :weight thin :height 1.0))))
 '(font-latex-string-face ((t (:foreground "#dc322f"))))
